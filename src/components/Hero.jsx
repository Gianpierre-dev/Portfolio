...
const Hero = () => {
  ...
  return (
    <section 
      id="hero" 
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-blue-50 to-white overflow-hidden"
      style={{ paddingTop: '80px' }}
    >
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"
          style={{ animationDelay: '0s' }}
        />
        <div 
          className="absolute top-1/3 right-1/4 w-64 h-64 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"
          style={{ animationDelay: '2s' }}
        />
        <div 
          className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"
        ...
        <div className="text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
              Hola, soy{' '}
              <span className="gradient-text">Anthony Terrazas</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Desarrollador de Software Junior especializado en{' '}
              <span className="text-blue-600 font-semibold">Python</span>,{' '}
              <span className="text-blue-600 font-semibold">React</span> y{' '}
              <span className="text-blue-600 font-semibold">Análisis de Datos</span>
            </p>
            ...
            <div className="flex justify-center gap-6 mt-12">
              ...
              <a 
                href="https://linkedin.com/in/anthony-gianpierre-terrazas-tello-9b2b97224" 
                target="_blank" 
                rel="noopener noreferrer"
