...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/anthony-gianpierre-terrazas-tello-9b2b97224',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:pier_terrazas@hotmail.com',
      icon: (
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container section-padding">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed">
                Desarrollador de Software Junior especializado en crear 
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                {['Inicio', 'Sobre mí', 'Experiencia', 'Habilidades', 'Contacto'].map((item) => (
                  <li key={item}>
                    <a
        ...
        <div className="border-t border-gray-800 py-6 text-center text-gray-400">
          <p>
            © {currentYear} Anthony Gianpierre Terrazas Tello. Todos los derechos reservados.
          </p>
          <p className="mt-2 text-sm">
            Hecho con ❤️ y React + Tailwind CSS 4
          </p>
        </div>
      </div>
    </footer>
